...
VIDEO_PATH = r"D:\Projetc_Helmet\Folder_video\helmet10.mp4"
...
def is_rider(person_box, bike_box):
    ...
    expand_x = int(0.55 * (bx2 - bx1))
    expand_y = int(0.65 * (by2 - by1))
